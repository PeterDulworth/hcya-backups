...
@media screen and (min-width: 0px) { /*Rules apply as long as screen width > 0px*/
	<?php ?>
}
@media screen and (min-width: 650px) { /*Rules apply as long as screen width > 650px*/
	<?php ?>
}
@media screen and (min-width: 725px) { /*Rules apply as long as screen width > 725px*/
	<?php ?>
}
@media screen and (min-width: 850px) { /*Rules apply as long as screen width > 850px*/
	<?php ?>
}
