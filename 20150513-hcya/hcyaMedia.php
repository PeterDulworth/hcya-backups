...
<html !DOCTYPE> 
	...
	<!-- * * * * * * * * * WELCOME * * * * * * * * *  -->
					<div id="gallerybox">
						<div id="gallerybox-container">
							<div class="text" style="font-size: 50; border-bottom: 1px inset white">Photos</div><br><br>
							<div class="pure-g" style="padding:0">
								<div class="pure-u-1-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								...
								<div class="pure-u-1-3"><img src="imgs/hcya/shoes-2013.jpg" /></div>
							</div>
